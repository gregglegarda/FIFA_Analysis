...
# PCA wage_skills
#pca_wage_skills_center <- prcomp(data_wage_skills, center = TRUE,scale. = TRUE) #center
#pca_wage_skills_raw <- prcomp(data_wage_skills, center = TRUE,scale. = FALSE) #raw
#summary(pca_wage_skills_center)
#summary(pca_wage_skills_raw)

# pca value_skills
#pca_value_skills_center <- prcomp(data_value_skills, center = TRUE,scale. = TRUE) #center
#pca_value_skills_raw <- prcomp(data_value_skills, center = TRUE,scale. = FALSE) #raw
#summary(pca_value_skills_center)
#summary(pca_value_skills_raw)
