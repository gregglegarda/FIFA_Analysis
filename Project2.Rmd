...
#### Q1.1: How did the value of players vary according to the positions they play?
...
#### Q1.2: What skills make strikers valuable?
...
## Smart Question 3
#### What variables are important for a goalkeeper’s potential? 
...
``` {r structure1, echo=TRUE, results='hide', include= TRUE}
...
#### Wage-Skills
```{r S4e, echo=TRUE, results='hide', include= TRUE}
...
#### Value-Skills
```{r S4f, echo=TRUE, results='hide', include= TRUE}
...
#### Wage VIF
```{r S4g, echo=TRUE, results='hide', include= TRUE}
#Perforsm VIF for Wage vs Skills Linear Model
vif(wage_lm)
```

#### Value VIF
```{r S4gg, echo=TRUE, results='hide', include= TRUE}
