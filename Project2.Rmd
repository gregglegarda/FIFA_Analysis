...
## What variables contribute most to a player’s skill in penalty shots? How much does Aggression, Composure and physical fitness attributes contribute to a player's skill, and which combinations are most influencial?
...
### ***Clean Up Wage and Value Data fff
...
data_value_skills$ValueMM <- ln(as.numeric(data_value_skills$ValueMM)*1000000)
data_value_skills$ValueKK <- ln(as.numeric(data_value_skills$ValueKK)*1000)
